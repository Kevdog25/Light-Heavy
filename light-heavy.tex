...
\begin{figure}
	\begin{center}
		\begin{subfigure}[t]{0.4\linewidth}
			%\centering
			\includegraphics[width = 1.12\textwidth] {figs/x_Au_200GeV/"Au_200GeV_b=0_Eccentricities_Deuteron,Helium3_Smooth".png}
			\subcaption{Single Gaussian\label{subfig:SmAub=0}}
		\end{subfigure}
		\begin{subfigure}[t]{0.4\linewidth}
			%\centering
			\includegraphics[width = 1.12\textwidth] {figs/x_Au_200GeV/"Au_200GeV_b=0_Eccentricities_Deuteron,Helium3_Fluctuated".png}
...
%		\includegraphics[width = \textwidth]{figs/MultiplicityVsB/"MultiplicityVsNpart_p_Pb".png}
%		\subcaption{}
%		\label{subfig:MultVsNpart}
%	\end{subfigure}
%	\begin{subfigure}{0.3\linewidth}
%		\includegraphics[width = \textwidth]{figs/MultiplicityVsB/"NpartVsb_p_Pb".png}
%		\subcaption{}
%		\label{subfig:NpartVsb}
%	\end{subfigure}
%	\begin{subfigure}{0.3\linewidth}
%		\includegraphics[width = \textwidth]{figs/MultiplicityVsB/"MultiplicityVsb_p_Pb".png}
%		\subcaption{}
